...
本分科会では、ユースケース分科会コントリビュータとして、SNIA日本支部に入会されていない個人の方でも毎月開催の分科会へご参加頂けます。
参加をご希望される方は、「ユースケース分科会コントリビュータ希望」と明記の上、SNIA日本支部事務局(office@snia-j.org)までご連絡ください。

##### ユースケース分科会コントリビュータとは

ユースケース分科会では、ストレージを利用・運用されている方々の様々な知見を持ち寄り議論することで分科会を盛り上げるべく、SNIA日本支部の会員外の方でもユースケース分科会の活動にご参加頂ける「ユースケース分科会コントリビュータ」を開始しました。
...
- 登録は原則1年です
  - 毎年(年度末)に登録の見直しを行います
  - 継続の場合には、登録見直し時に会長までご連絡ください
- 分科会の運営に支障がでるようなケースが発生した場合には、会長の判断により登録を削除する場合があります